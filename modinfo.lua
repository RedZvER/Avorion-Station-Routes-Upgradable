...
meta =
{
    ...
    name = "StationRoutesUpgradable",

    -- Title of your mod that will be displayed to players
    title = "Station Routes Upgradable",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds an upgrade button that increases the maximum number of Supply and Delivery routes on player factories (from 3 up to 6).",
    ...
    contact = "https://steamcommunity.com/id/red_jd/",
}
